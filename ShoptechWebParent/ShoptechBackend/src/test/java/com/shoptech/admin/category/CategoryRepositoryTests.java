...
public class CategoryRepositoryTests {
    ...
    @Test
    public void findRootHierarchical(){
        Category laptops = repo.findById(3L).get();
        System.out.println(laptops.getName());
        System.out.println(printParent(laptops));
    }

    public String printParent(Category children){
        Category parent = children.getParent();
        if(parent == null) {
            return "";
        }

        return printParent(parent) + "/" + parent.getName();
    }
