...
$(document).ready(function(){
    ...
    $("#productList").on('input', ".quantity-input", function(e){
    ...
    $("#productList").on('input', ".cost-input", function(e){
        updateSubtotalWhenPriceChanged($(this));
        updateOrderAmounts();
    });
    $("#productList").on('input', ".ship-input", function(e){
        updateSubtotalWhenPriceChanged($(this));
        updateOrderAmounts();
    });
});
...
function updateSubtotalWhenPriceChanged(input){
    ...
    let quantityValue = parseFloat(quantityField.val());
    let newSubtotal = priceValue * quantityValue;
