...
function prepareChartDataForSalesReportByProduct(responseJSON){
    ...
    $.each(responseJSON, function(index, reportItem){
        data.addRows([[reportItem.identifier, reportItem.productsCount, reportItem.grossSales,
            reportItem.netSales]]);
...
function drawChartForSalesReportByProduct(period){
    let salesChart = new google.visualization.Table(
        document.getElementById('chart_sales_by_product'));
